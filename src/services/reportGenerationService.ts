...
async function generateVisualizations(analysis: Analysis): Promise<Array<{
  type: string;
  title: string;
  data: any;
}>> {
...
function calculateConcreteByElement(elements: Array<{ type: string; concrete: number }>): Record<string, number> {
...
function calculateSteelByElement(elements: Array<{ type: string; steel: number }>): Record<string, number> {
  return elements.reduce((acc, element) => {
...
function calculateConcreteDistribution(elements: Array<{ type: string; concrete: number }>): Record<string, number> {
  return calculateConcreteByElement(elements);
}

function calculateSteelDistribution(elements: Array<{ type: string; steel: number }>): Record<string, number> {
